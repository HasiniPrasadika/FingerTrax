...
const AttendanceRecord = () => {
    ...
    return (
        <div className='att-container'>
            ...
            <div>
            <span style={{padding:'5px' , fontSize:'18px', color:'#4154F1'}}>Dashboard</span>    
            </div>
            <div>
                    <Link to="/studentdashboard" style={{ opacity: '0.8', padding: '5px', paddingRight: '0px', fontSize: '12px',color:"black" }}>
                        <GoTriangleRight /> Dashboard/
                    </Link>
                    <span style={{padding:'2px' , fontSize:'12px',fontWeight:'bold'}}>EE5301 Discreate Mathematics </span>
            </div>
                <div className='att-details'>
                    <div className="attendance-square">
                        <div style={{fontWeight:'bold', fontSize:'14px'}}>Discreate Mathematics</div>
            ...
            <div className='attendance-list'>
                <h3 style={{ marginBottom:'20px', color:'#012970' ,marginLeft:'5px'}}>Attendance Record</h3>
