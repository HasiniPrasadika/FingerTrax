...
const App = () => {
  ...
  const Sidebar = role === 'admin' ? AdminSidebar : role === 'student' ? StudentSidebar : LectureSidebar;
  const Header = role === 'admin' ? AdminHeader : role === 'lecturer' ? LectureHeader : StudentHeader;
